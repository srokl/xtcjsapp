...
export async function mergeFiles(
  ...
  switch (validation.type) {
    case 'cbz':
      return mergeCbzFiles(files, outputFormat, onProgress, dimensions)
    case 'pdf':
      return mergePdfFiles(files, outputFormat, onProgress, dimensions)
    case 'xtc':
      return mergeXtcFiles(files, outputFormat, onProgress, dimensions)
    default:
